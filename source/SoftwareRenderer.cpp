...
void dae::SoftwareRenderer::ToggleRotation()
{
	if (!m_RotationToggle)
	{
...
void dae::SoftwareRenderer::Initialize(std::vector<Texture*>& mainTextures, Camera* pCamera, const Mesh& vehicleMesh)
{
	m_pCamera = pCamera;
	m_Meshes[0] = vehicleMesh;
